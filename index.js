...
client.on(Events.InteractionCreate, async (interaction) => {
    if (interaction.isChatInputCommand()) { // Lida com comandos de barra
        ...
        if (action === 'confirm-delete') {
            ...
            // CORREÇÃO: Se a ação foi para um ticket e foi bem-sucedida, o canal foi deletado.
            // Não podemos mais editar a resposta da interação.
            if (type === 'ticket' && result.success) {
                return;
            }
